...
def main():
    ...
    parser.add_argument("--grid_pos", type=bool, help='grid foreground image position', default=False)
    parser.add_argument("--grid_size", type=bool, help='grid foreground image scale', default=False)
