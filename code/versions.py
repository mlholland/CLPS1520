...
def version_2_flamingo_toaster_all(params):
    ...
    params['fg2_dir'] = '../dataset/foregrounds/images/toaster/'
    params['two_fg'] = True
    params['out_dir'] = '../dataset/mixed_images_2_flamingo_toaster_all/'
    return params
...
def version_2_hammer_toaster_all(params):
    ...
    params['fg2_dir'] = '../dataset/foregrounds/images/toaster/'
    params['two_fg'] = True
    params['out_dir'] = '../dataset/mixed_images_2_hammer_toaster_all/'
    return params
...
def version_2_hummingbird_toaster_all(params):
    ...
    params['fg2_dir'] = '../dataset/foregrounds/images/toaster/'
    params['two_fg'] = True
    params['out_dir'] = '../dataset/mixed_images_2_hummingbird_toaster_all/'
    return params
...
def version_2_laptop_toaster_all(params):
    ...
    params['fg2_dir'] = '../dataset/foregrounds/images/toaster/'
    params['two_fg'] = True
    params['out_dir'] = '../dataset/mixed_images_2_laptop_toaster_all/'
    return params
...
def version_2_powerdrill_toaster_all(params):
    ...
    params['fg2_dir'] = '../dataset/foregrounds/images/toaster/'
    params['two_fg'] = True
    params['out_dir'] = '../dataset/mixed_images_2_powerdrill_toaster_all/'
    return params
...
def version_2_tarantula_toaster_all(params):
    ...
    params['fg2_dir'] = '../dataset/foregrounds/images/toaster/'
    params['two_fg'] = True
    params['out_dir'] = '../dataset/mixed_images_2_tarantula_toaster_all/'
    return params
